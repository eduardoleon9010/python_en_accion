# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 16:47:16 2024
...
def mostrar_menu() -> int:
    """Muestra el menú de opciones y retorna la elección del usuario."""
    ...
    if respuesta.isnumeric():
        ...
        print("Debe ingresar un valor numérico. Suponemos que no quiere más cartas")
        opcion = 2

    return opcion

def mostrar_primera_carta(mano: dict) -> None:
    """Muestra la primera carta de la mano."""
...
def mostrar_juego_actual(mano_jugador: dict, mano_casa: dict, abrir_casa: bool = False) -> None:
...
def turno_casa(puntos_jugador: int, mano_casa: dict) -> bool:
    """Maneja el turno de la casa."""
    continuar_juego = True
    puntos_casa = juego.contar_puntos_mano(mano_casa)

    if puntos_casa > puntos_jugador:
        print("La casa gana: {} de la casa vs {} del jugador".format(puntos_jugador, puntos_casa))
        continuar_juego = False
    else:
