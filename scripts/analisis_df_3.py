# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 09:26:22 2024
...
def mostrar_value_counts_columna():
    columna = input("\nIngrese el nombre de la columna para aplicar value_counts(): ")
    if columna in df_peajes.columns:
        print(f"\nCantidad de veces que aparece cada valor en la columna '{columna}':")
        print(df_peajes[columna].value_counts())
    else:
        print(f"La columna '{columna}' no existe en el DataFrame.")

def mostrar_maximos_tarifas():
    print("\nValor máximo de cada tarifa:")
    print(numericas.max())

def mostrar_id_maximo_tarifas():
    print("\nID de las categorías que contienen el valor máximo de cada tarifa:")
    print(numericas.idxmax())
...
while True:
    ...
    print("9. Mostrar conteo de una columna específica")
    print("10. Mostrar valor máximo de cada tarifa")
    print("11. Mostrar ID de las categorías que contienen el valor máximo de cada tarifa")
    print("12. Salir")
    ...
    if opcion == '1':
        ...
        mostrar_value_counts_columna()
    elif opcion == '10':
        mostrar_maximos_tarifas()
    elif opcion == '11':
        mostrar_id_maximo_tarifas()
    elif opcion == '12':
